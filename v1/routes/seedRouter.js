...
seedRouter.post("/", async (req, res) => {
    try {
        ...
        const user_3A = new User({
            ...
            last_name: "Jansen",
            gender: "Vrouw",
            email: "annajansen@email.nl",
            adres: "Wijnhaven 107",
            nationality: "Nederlandse",
            postcode: "3011 WN",
            birth_date: new Date("2000-05-12"),
            phone_number: "0612345678",
            password_hash: password_3A,
            is_admin: false,
        ...
        const adminUser_3A = new User({
            ...
            last_name: "3A",
            gender: "Man",
            email: "admin3a@cmgt.nl",
            adres: "Wijnhaven 107",
            nationality: "Nederlandse",
            postcode: "3011 WN",
            birth_date: new Date("1990-01-01"),
            phone_number: "0611111111",
            password_hash: admin_3A,
            is_admin: true,
            personalization_enabled: true,
            bsn: "111111111"
        });
        ...
        const user_3B = new User({
            ...
            gender: "Man",
            email: "Bas@email.nl",
            adres: "'s-Gravenweg 123",
            nationality: "Nederlands",
            postcode: "2911 AA",
            birth_date: new Date("1950-03-05"),
            phone_number: "0612345678",
            password_hash: password_3B,
            is_admin: false,
            personalization_enabled: true,
            bsn: "123456385"
        });
        ...
        const adminUser_3B = new User({
            ...
            last_name: "3B",
            gender: "Man",
            email: "admin3b@zuidplas.nl",
            adres: "'s-Gravenweg 123",
            nationality: "Nederlands",
            postcode: "2911 AA",
            birth_date: new Date("1990-01-01"),
            phone_number: "0622222222",
            password_hash: admin_3B,
            is_admin: true,
            personalization_enabled: true,
            bsn: "222222222"
        });
